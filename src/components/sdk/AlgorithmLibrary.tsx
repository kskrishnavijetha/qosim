...
const algorithmDatabase: Algorithm[] = [
  {
    ...
    gates: [
      ...
      { id: 'cnot1', type: 'CNOT', qubit: 1, position: 1, controlQubit: 0 }
    ],
    code: {
...
cx q[0],q[1];`
  ...
  },
  {
    ...
    gates: [
      ...
      { id: 'cz1', type: 'CZ', qubit: 1, position: 1, controlQubit: 0 },
      { id: 'cz2', type: 'CZ', qubit: 2, position: 1, controlQubit: 1 }
    ],
    code: {
          ...
          <Card key={algorithm.id} className="quantum-panel neon-border hover:neon-glow transition-all cursor-pointer">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                ...
                <div className="text-center">
                  <div className="text-quantum-energy font-mono">{algorithm.gateCount}</div>
