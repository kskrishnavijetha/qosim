...
import { Download, Share, Code, FileJson, Globe } from 'lucide-react';

interface QNNExportPanelProps {
  architecture: QNNArchitecture;
  onExport: (format: 'python' | 'javascript' | 'json') => void;
}
    ...
    <Card className="quantum-panel neon-border">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-semibold text-quantum-neon">SDK Export</h4>
